...
class Custom_Search_Admin {
	...
	public function cs_admin_menu(){
		$cs_screen_page = add_menu_page('Search Pages', 'Search Pages', 'edit_posts', 'search-pages',array(&$this, 'all_search_pages'),'dashicons-admin-site',5);
		 add_submenu_page( 'search-pages', 'New Search Page', 'Add New', 'edit_posts', 'new-search-page', array(&$this, 'add_search_page') );
